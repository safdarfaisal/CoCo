...
const NonTerminal NonTerminalProd[57] = {
    {program, {0}, 1},
    {mainFunction, {1}, 1},
    {otherFunctions, {2, 3}, 2},
    {function, {4}, 1},
    {input_par, {5}, 1},
    {output_par, {6, 7}, 2},
    {parameter_list, {8}, 1},
    {dataType, {9, 10}, 2},
    {primitiveDatatype, {11, 12}, 2},
    {constructedDatatype, {13, 14, 15}, 3},
    {remaining_list, {16, 17}, 2},
    {stmts, {18}, 1},
    {typeDefinitions, {19, 20}, 2},
    {isRedefined, {21, 22}, 2},
    {typeDefinition, {23, 24}, 2},
    {fieldDefinitions, {25}, 1},
    {fieldDefinition, {26}, 1},
    {moreFields, {27, 28}, 2},
    {declarations, {29}, 1},
    {declaration, {30}, 1},
    {global_or_not, {31, 32}, 2},
    {otherstmts, {33, 34}, 2},
    {stmt, {35, 36, 37, 38, 39}, 5},
    {assignmentStmt, {40}, 1},
    {singleOrRecId, {41}, 1},
    {singleLeft, {42, 43}, 2},
    {oneExpansion, {44}, 1},
    {moreExpansions, {45, 46}, 2},
    {funCallStmt, {47}, 1},
    {outputParameters, {48, 49}, 2},
    {inputParameters, {50}, 1},
    {iterativeStmt, {51}, 1},
    {conditionalStmt, {52}, 1},
    {elseStmt, {53, 54}, 2},
    {ioStmt, {55, 56}, 2},
    {arithmeticExpression, {57}, 1},
    {expPrime, {58, 59}, 2},
    {term, {60}, 1},
    {termPrime, {61, 62}, 2},
    {factor, {63, 64}, 2},
    {highPrecedenceOps, {65, 66}, 2},
    {lowPrecedenceOps, {67, 68}, 2},
    {booleanExpression, {69, 70, 71}, 3},
    {var, {72, 73}, 2},
    {logicalOp, {74, 75}, 2},
    {relationalOp, {76, 77, 78, 79, 80, 81}, 6},
    {returnStmt, {82}, 1},
    {optionalReturn, {83, 84}, 2},
    {idList, {85}, 1},
    {moreIds, {86, 87}, 2},
    {definetypestmt, {88}, 1},
    {a, {89, 90}, 2}
